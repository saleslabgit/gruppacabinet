...
с секундами, в часовом поясе Europe/Minsk; сохраняются UTC. Они отсутствуют
в создании группы и у психолога. Окончание должно быть позже публикации,
если обе даты заполнены. Используются текущие input/panel/validation компоненты
