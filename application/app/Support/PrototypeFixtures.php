...
final class PrototypeFixtures
{
    ...
    public static function page(string $slug, string $variant): array
    {
        ...
        $user = [
            ...
            'trainings' => $variant === 'empty' ? [] : [
                ['modality_program' => $long ? str_repeat('Демонстрационная программа ', 12) : 'Групповая работа · демонстрационная программа', 'training_center' => 'Учебный центр «Пример»', 'graduation_year' => 2020, 'training_hours' => 600],
                ['modality_program' => 'Вторая демонстрационная программа', 'training_center' => null, 'graduation_year' => 2024, 'training_hours' => 120],
            ],
            'license_number' => 'DEMO-LICENSE-000', 'license_expires_at' => '2027-12-31',
