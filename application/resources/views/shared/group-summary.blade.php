...
<p class="meta mt-3">{{ match($group['status']) {
    'awaiting_payment' => 'Заполнение анкеты станет доступно после подтверждения оплаты.',
    ...
    'active' => 'Группа опубликована и принимает заявки.',
    'expired' => 'Размещение завершено. После продления потребуется ручная повторная публикация.',
} }}</p>
