...
<x-button kind="danger" data-bs-toggle="modal" data-bs-target="#delete-dictionary-{{ $row->id }}">Удалить</x-button>
@endif
</div></x-cell>
</tr>
@endforeach
...
@if($editing) <x-button kind="ghost" :href="route('admin.dictionaries.index')">Отмена</x-button> @endif
@else
